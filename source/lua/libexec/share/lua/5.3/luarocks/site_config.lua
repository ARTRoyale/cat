local site_config = {}
site_config.LUAROCKS_PREFIX=[[/usr/local/opt/lua/libexec]]
site_config.LUA_INCDIR=[[/usr/local/include]]
site_config.LUA_LIBDIR=[[/usr/local/lib]]
site_config.LUA_BINDIR=[[/usr/local/bin]]
site_config.LUA_INTERPRETER=[[lua5.3]]
site_config.LUAROCKS_SYSCONFDIR=[[/usr/local/etc/luarocks53]]
site_config.LUAROCKS_ROCKS_TREE=[[/usr/local]]
site_config.LUAROCKS_ROCKS_SUBDIR=[[/lib/luarocks/rocks-5.3]]
